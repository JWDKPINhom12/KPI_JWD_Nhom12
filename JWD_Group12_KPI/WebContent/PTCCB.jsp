...
<title>Phòng tổ chức cán bộ</title>
...
<body>
   	...
   	<div id="kpigv" class="tab-pane fade in active">
		...
		<table class="table table-bordered table-striped">
			...
			<tr>
				...
				<td>KPI1</td>
				<td>9/9/2016</td>
				<td><a href="ChiTietKPI-PTC.html">xem</a></td>
				<td><a href="DanhGiaKPI-PTC.html">xem</a></td>
			</tr>
			<tr>
				<td>456</td>
				<td>Trần Thị B</td>
	...
	<a href="PhanCongcv.html" class="btn btn-primary" role="button">Thêm công việc</a>
    </div>
  </div>
</div>
