...
<sql:query dataSource="${snapshot}" var="result">
		SELECT * from danhsachbm where makpi = '<%= request.getParameter("y") %>';
		</sql:query>

<div class="container">
<form method="post" class="form-horizontal" action ="UpdateBM.jsp" id="signup" role="form">
<fieldset>
<c:forEach var="row" items="${result.rows}">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="makpi" value="${row.makpi}" name="makpi" type="text" class="form-control input-md">    
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="muctieu" value="${row.muctieu}" name="muctieu" type="text" class="form-control input-md">    
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="noidung" value="${row.noidung}" name="noidung" type="text" class="form-control input-md">    
  </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="tgbd">Thời gian bắt đầu</label>  
        <div class="col-md-4">
            <input type="text" value="${row.tgbd}" name="tgbd" class="form-control input-md" id="tgbd">
        </div>
</div>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="tgkt">Thời gian kết thúc</label>
        <div class="col-md-4">
            <input type="text" value="${row.tgkt}" name="tgkt" class="form-control input-md" id="tgkt">
        </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4"> 
  <input id="ctdk" name="ctdk" value="${row.ctdk}" type="text" class="form-control input-md">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4"> 
  <input id="dkpimax" name="dkpimax" value="${row.dkpimax}" type="text" class="form-control input-md">
  </div>
</div>
