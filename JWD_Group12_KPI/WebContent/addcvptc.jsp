...
<body>
	...
	try{
	    ...
	    if (i > 0 ) {
	        out.print("Add Successfull!"+"<a href='PhanCongcv-PTC.jsp'>Go back</a>");
	    } else {
	        out.print("Add fail!"+"<a href='PhanCongcv-PTC.jsp'>Go back</a>");
	    }
	    }
	    else{
	    	out.print("!!!"+"<a href='PhanCongcv-PTC.jsp'>Go back</a>");
	    }
